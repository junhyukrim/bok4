...
class NewsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        df = pd.read_csv('C:/Users/wosle/OneDrive/Desktop/Bok_Projet_woslek/Financial_News_text/news_scraper/news_scraper/spiders/naver_news_20080101_20080108_Financial_News copy.csv')
        urls = df['url'].tolist()
    ...
    def parse(self, response):
        ...
        content = ' '.join(response.css('article.go_trans_article_content::text').getall()).strip()
