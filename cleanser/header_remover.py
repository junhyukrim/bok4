...
# 설정 값
folder_path = "C:/Users/egege/OneDrive/Documents/bok4_resource/bond_txt/bond_txt/0_패턴분석완료_대우증권/output/daewoopattern/daewoopattern_cleaned"  # txt 파일이 있는 폴더 경로
