...
word_list = ['대우증권 리서치센터', '돌아온 박스권', '미 신용스프레드', '선물종가 - 외인 매수단가 20일 이동 평균', 
             'S&P 500지수 미국채 10년', '500 금융서비스업', '은행업', '보험업', 'EMBI+ 스프레드 외인 누적순매수', '11000 실업률']
