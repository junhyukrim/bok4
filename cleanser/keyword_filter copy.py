...
# 키워드 리스트 정의
keywords = ["자료:"]  # 원하는 키워드를 여기에 추가

# 폴더 경로 설정
base_folder = "C:/Users/egege/OneDrive/Documents/bok4_resource/bond_pdf/bond_reports_pdf-20250227T122256Z-003/bond_reports_pdf/하나/Type2"
keyword_yes_folder = os.path.join(base_folder, "graph")
...
bbox = (0, 700, 250, 830)  # x0, top, x1, bottom
